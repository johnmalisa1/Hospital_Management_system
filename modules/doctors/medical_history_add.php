...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($condition !== '' && $date_recorded !== '' && preg_match('/^\d{4}-\d{2}-\d{2}$/', $date_recorded)) {
        $medicalHistoryService->addHistory($patient_id, $condition, $treatment, $date_recorded, $doctor_id);
    }
...
<body class="sidebar-page">
    ...
    <h2 style="text-align:center;"><i class="fas fa-heartbeat"></i> Add Medical History</h2>
    ...
    <div class="form-container">
        <form method="POST">
            ...
            <input type="text" name="condition" required placeholder="Enter condition">

            <label>Treatment:</label>
            <textarea name="treatment" rows="3" placeholder="Treatment details"></textarea>
